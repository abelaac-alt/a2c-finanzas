  ...
  app.innerHTML=`<div class="app-shell">
    <header class="topbar">
      ...
      <div class="top-actions">
        <button class="icon-btn install-btn hidden" id="install-app">Instalar app</button>
        <button class="icon-btn" id="notifications" aria-label="Notificaciones" title="Notificaciones">${uiIcons.bell}${unread?`<span class="badge">${unread}</span>`:''}</button>
        ${isAdmin()?`<button class="icon-btn" id="admin" aria-label="Administración" title="Administración">${uiIcons.settings}</button>`:''}
        <button class="icon-btn" id="profile" aria-label="Mi perfil" title="Mi perfil">${uiIcons.user}</button>
        <button class="icon-btn logout-btn" id="logout" aria-label="Cerrar sesión" title="Cerrar sesión">${uiIcons.logout}<span>Salir</span></button>
      </div>
    </header>
