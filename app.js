...
function renderSocial(){
  ...
  <div class="social-feed">${posts.length?posts.map(socialPostMarkup).join(''):'<div class="empty">Todavía no hay publicaciones visibles.</div>'}</div>${leaderboardSection()}</section>`;
}
