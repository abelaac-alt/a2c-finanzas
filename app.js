...
async function loadAll(){
  ...
  [state.resources,state.members,state.invitations,state.transactions,state.notifications,state.recurring,state.cryptoHoldings,state.cryptoLedger,state.socialPosts,state.friendships,state.follows,state.socialProfiles]=result.slice(0,12).map(r=>r.data||[]);
