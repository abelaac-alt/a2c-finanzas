...
async function loadAll(){
  try{await sb.rpc('a2c_process_my_scheduled_movements_v62');}
  catch(error){console.warn('No se pudieron procesar los movimientos programados.',error);}
  ...
  result.forEach((row,index)=>{if(row?.error){console.warn(`A2C: consulta opcional ${index} no disponible`,row.error);result[index]={data:[]};}});
