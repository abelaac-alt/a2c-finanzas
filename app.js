...
function rankingBadgeAsset(badge){
  const category={investment_cents:'inversiones',saving_cents:'ahorro',income_cents:'ingresos'}[badge.key]||'ingresos';
